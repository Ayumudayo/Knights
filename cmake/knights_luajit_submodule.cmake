function(knights_configure_luajit_submodule out_target)
    if (TARGET knights_luajit_vendor)
        set(${out_target} knights_luajit_vendor PARENT_SCOPE)
        return()
    endif()
    ...
    if (WIN32)
        ...
        set(_luajit_build_command "${KNIGHTS_LUAJIT_MAKE_PROGRAM}" BUILDMODE=static)
    ...
    if (UNIX AND NOT APPLE)
        set_property(TARGET knights_luajit_vendor APPEND PROPERTY
            INTERFACE_LINK_LIBRARIES "m;dl")
    endif()

    add_dependencies(knights_luajit_vendor knights_luajit_vendor_build)
    set(${out_target} knights_luajit_vendor PARENT_SCOPE)
endfunction()
