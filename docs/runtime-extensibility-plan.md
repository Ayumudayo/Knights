...
### 1.1 초기 기준선(Phase 16 이전 역사적 상태)

아래 표는 이 계획이 처음 작성될 당시의 출발점이다. 현재 구현 상태는 본 문서 상단의 "최근 구현 반영"과 `docs/core-api/extensions.md`, `docs/extensibility/governance.md`를 기준으로 해석한다.
